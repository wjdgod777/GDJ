...
public class Library {
	...
	private Book[] books;	// 사용자 입력
	private int idx;		// 사용자 입력
	...
	private void findBook() {
		...
		String title = sc.next();
		for(int i = 0; i < idx; i++) {
			// 저장된 책의 제목 : books[i].getTitle()
			// 조회할 책의 제목 : title
			// String의 동등 비교 : equals() 메소드
			if(books[i].getTitle().equals(title)) {		// 거꾸로도 가능. if(title.equals.(books[i].getTitle())
