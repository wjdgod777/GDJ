...
public class Ex01_array {
	...
	public static void main(String[] args) {
		...
		//	  int[][] arr;
		// 2. 2차원배열의 생성
		//	  1) arr = new int[3][2];	- 3행 2열의 구조(김밥 3줄, 2등분)	
		//	  2) arr = new int[3][];	- 3행 n열의 구조(김밥 3줄, n등분)
		//	     arr[0] = new int[5];	- 1번째 1차원 배열(1 번째 김밥은 5등분)
		//	     arr[1] = new int[3];	- 2번째 1차원 배열(2 번째 김밥은 3등분)
		//	     arr[2] = new int[8];	- 3번째 1차원 배열(3 번째 김밥은 8등분)
