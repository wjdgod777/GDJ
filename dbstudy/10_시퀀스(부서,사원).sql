...
/*
    ...
    CREATE SEQUENCE 시퀀스_이름
        ...
        CYCLE사용유무                -- 생략한다면 NOCYCLE, PK에서 사용한다면 NOCYCLE
*/
...
-- 사원 테이블에 행(Row) 삽입
-- 자식 테이블(관계에서 FK를 가진 테이블)은 참조 물결성에 위배되지 않는 데이터만 삽입 가능
-- 부서(부서번호) - 사원(소속부서)
-- PK             - FK
-- 1,2,3,4        - 1,2,3,4 중 하나
INSERT INTO
    EMPLOYEE
VALUES
...
-- 최초 1번은 NEXTVAL을 사용해야 CURRVAL도 사용 가능함
